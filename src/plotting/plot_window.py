...
def plot_random_windows_of_activity(x, y, t, timestamps, activity_mapping, activity, n=3, seed=123):
    ...
    t_filtered = t[activity_mask]
    timestamps_filtered = timestamps[activity_mask]
    ...
    for idx in indices:
        plot_window(x_filtered[idx], y_filtered[idx], t_filtered[idx], timestamps_filtered[idx], activity_mapping)